frappe.ui.form.on('Project', {
	project_checklist_template_cf(frm) {
		if (frm.doc.project_checklist_template_cf) {
			...
			frappe.model.with_doc("Project Checklist Template PM", frm.doc.project_checklist_template_cf, function () {
				var tabletransfer = frappe.model.get_doc("Project Checklist Template PM", frm.doc.project_checklist_template_cf)
